...
namespace web
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                //No Else colocar a Connection String do Servidor 
#if DEBUG
                optionsAction.UseNpgsql(Configuration.GetConnectionString("DefaultConnection"));
#else
                optionsAction.UseNpgsql("Server=localhost;Port=5432;User Id=postgres;Password=postgres;Database=arquitetura;Timeout=1024;CommandTimeout=10000;");
#endif
